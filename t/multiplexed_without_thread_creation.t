...
#
# These tests will allow to migrate the last specific server thread (graphic) in the common thread mecanism (sub
# create_new_server) => code simplification, powerful system of thread (no package limitation, no instance limitation,
# may be instance(s) thread as well as class thread (or both !), integrated dynamic methods capabilities for dynamic design, ...)
